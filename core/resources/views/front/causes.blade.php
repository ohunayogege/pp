                            ...
                            <div class="causes-box mb-40">
                                ...
                                <div class="causes-content">
                                    ...
                                    <div class="content-info">
                                        <h3><a href="{{route('front.cause_details', [$cause->slug, $cause->id])}}">{{convertUtf8(strlen($cause->title)) > 30 ? convertUtf8(substr($cause->title, 0, 30)) . '...' : convertUtf8($cause->title)}}</a></h3>
                                        ...
                                        <p>{!! (strlen(strip_tags(convertUtf8($cause->content))) > 100) ? substr(strip_tags(convertUtf8($cause->content)), 0, 100) . '...' : strip_tags(convertUtf8($cause->content)) !!}</p>
                                        <a href="{{route('front.cause_details', [$cause->slug, $cause->id])}}" class="readmore-btn"><span>{{__('Read More')}}</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
