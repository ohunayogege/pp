...
@section('content')
  ...
  <section
    class="course-area-v1 pt-120 pb-120 bg_cover"
          ...
          @foreach ($featured_courses as $featured_course)
            <div class="course-item col-lg-4">
                <div class="course-img">
                    ...
                    <a href="{{ route('course_details', ['slug' => $featured_course->slug,'id' => $featured_course->id]) }}" class="course-overlay">
                        <div class="rating">
              ...
              <div class="course-content">
                <h3>
                  <a href="{{ route('course_details', ['slug' => $featured_course->slug,'id' => $featured_course->id]) }}">
                    {{convertUtf8(strlen($featured_course->title)) > 30 ? convertUtf8(substr($featured_course->title, 0, 30)) . '...' : convertUtf8($featured_course->title)}}
                  </a>
                </h3>
              ...
              <div class="col-md-6 col-sm-12">
                <div class="course-item">
                  <div class="course-img">
                    ...
                    <a href="{{ route('course_details', ['slug' => $course->slug,'id' => $course->id]) }}" class="course-overlay">
                        <div class="rating">
                  ...
                  <div class="course-content">
                    <h3>
                      <a href="{{ route('course_details', ['slug' => $course->slug,'id' => $course->id]) }}">
                        {{convertUtf8(strlen($course->title)) > 30 ? convertUtf8(substr($course->title, 0, 30)) . '...' : convertUtf8($course->title)}}
                      </a>
                    </h3>
                    <div class="course-admin-price">
                      <div class="admin">
