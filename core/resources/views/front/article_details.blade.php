              ...
              >
                <div class="card-body">
                  ...
                  <ul class="list">
                    ...
                    <li>
                      <a href="{{ route('front.knowledgebase_details', ['slug' => $article->slug, 'id' => $article->id]) }}" class="{{$article->id == $details->id ? 'active' : ''}}">
                        {{ convertUtf8(strlen($article->title)) > 30 ? convertUtf8(substr($article->title, 0, 30) . '...') : convertUtf8($article->title) }}
                      </a>
                    </li>
                    @endforeach
                  </ul>
