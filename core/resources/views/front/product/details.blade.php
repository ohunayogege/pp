...
@section('breadcrumb-subtitle', strlen(convertUtf8($product->title)) > 40 ? substr(convertUtf8($product->title), 0, 40) . '...' : convertUtf8($product->title))
@section('breadcrumb-link', convertUtf8($product->title))
