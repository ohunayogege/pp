                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                @if ($data->status == 'Success')
                                                    <div class="col-lg-4 print-btn text-right">
                                                        {{QrCode::size(150)->generate("$data->transaction_id")}}
                                                        <div class="prinit d-block mt-1">
                                                            <a href="{{asset('assets/front/invoices/' . urlencode($data->invoice))}}" download="Ticket-{{$data->event->slug}}.pdf" id="print-click" class="btn"><i class="fas fa-print"></i>{{__('Download Ticket')}}</a>
                                                        </div>
                                                    </div>
                                                @endif
                                            </div>
