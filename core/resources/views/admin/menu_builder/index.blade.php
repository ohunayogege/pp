                    ...
                    <div class="card border-primary mb-3">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">{{__('Courses')}} <a data-text="{{__('Courses')}}" data-type="courses" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                <li class="list-group-item">{{__('Causes')}} <a data-text="{{__('Causes')}}" data-type="causes" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                <li class="list-group-item">{{__('Events')}} <a data-text="{{__('Events')}}" data-type="events" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
