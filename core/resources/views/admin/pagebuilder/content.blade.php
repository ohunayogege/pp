      ...
      var editor  = grapesjs.init({
        ...
        canvas: {
            styles: [
                ...
                @endif
                "{{asset('assets/admin/css/pb-canvas.css')}}",
            ...
            scripts: [
                ...
                @if($lang->rtl == 1)
                    @if($version == 'default' || $version == 'dark')
                        "{{asset('assets/admin/js/pb-default-custom-rtl.js')}}"
                    @endif
                    @if($version == 'gym')
                        "{{asset('assets/admin/js/pb-gym-custom-rtl.js')}}"
                    @endif
                    @if($version == 'car')
                        "{{asset('assets/admin/js/pb-car-custom-rtl.js')}}"
                    @endif
                    @if($version == 'cleaning')
                        "{{asset('assets/admin/js/pb-cleaning-custom-rtl.js')}}"
                    @endif
                    @if($version == 'construction')
                        "{{asset('assets/admin/js/pb-construction-custom-rtl.js')}}"
                    @endif
                    @if($version == 'logistic')
                        "{{asset('assets/admin/js/pb-logistic-custom-rtl.js')}}"
                    @endif
                    @if($version == 'lawyer')
                        "{{asset('assets/admin/js/pb-lawyer-custom-rtl.js')}}"
                    @endif
                @else
                    @if($version == 'default' || $version == 'dark')
