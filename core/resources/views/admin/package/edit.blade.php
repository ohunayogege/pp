                ...
                <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="duration" value="monthly" class="selectgroup-input" {{$package->duration == 'monthly' ? 'checked' : ''}}>
                            <span class="selectgroup-button">Monthly</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="duration" value="yearly" class="selectgroup-input" {{$package->duration == 'yearly' ? 'checked' : ''}}>
               ...
               @endif
                ...
                @if (getVersion($be->theme_version) == 'cleaning')
                    <div class="form-group">
                        ...
                        <input id="incolor" type="text" class="form-control jscolor" name="color" placeholder="Enter color" value="{{!empty($package->color) ? $package->color : 'e4e8f9'}}">
                ...
                @if ($bex->recurring_billing == 0)
                    <div class="form-group">
                        ...
                        <div class="selectgroup w-100">
                            <label class="selectgroup-item">
                                <input type="radio" name="order_status" value="1" class="selectgroup-input" {{$package->order_status == 1 ? 'checked' : ''}} onchange="toggleLink({{$package->id}}, 1)">
                                <span class="selectgroup-button">Active</span>
                            </label>
                            <label class="selectgroup-item">
                                <input type="radio" name="order_status" value="0" class="selectgroup-input" {{$package->order_status == 0 ? 'checked' : ''}} onchange="toggleLink({{$package->id}}, 0)">
                                <span class="selectgroup-button">Deactive</span>
                            </label>
                            <label class="selectgroup-item">
                                <input type="radio" name="order_status" value="2" class="selectgroup-input" {{$package->order_status == 2 ? 'checked' : ''}} onchange="toggleLink({{$package->id}}, 2)">
                ...
                <div class="form-group" id="externalLink{{$package->id}}" @if ($package->order_status != 2) style="display: none;" @endif>
