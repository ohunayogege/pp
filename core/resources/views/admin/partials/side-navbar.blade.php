    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                @endif
                <li class="nav-item
                    @if(request()->path() == 'admin/homeTheme') active
                    @endif">
                    <a href="{{route('admin.homeTheme') . '?language=' . $default->code}}">
                        <i class="la flaticon-home"></i>
                        <p>Theme & Home <span class="badge badge-danger p-1 sidenav-badge">Pagebuilder</span></p>
                    </a>
                </li>
                ...
                <li class="nav-item
                    ...
                    <div class="collapse
                        ...
                        <ul class="nav nav-collapse">
                            ...
                            <li class="submenu">
                                <a data-toggle="collapse" href="#manageSubscriptions" aria-expanded="{{(request()->routeIs('admin.subscriptions') && request()->input('type') != 'request') ? 'true' : 'false' }}">
                                <span class="sub-item">Subscriptions</span>
                                <span class="caret"></span>
                                </a>
                                <div class="collapse
                                    @if(request()->routeIs('admin.subscriptions') && request()->input('type') != 'request') show
                                    @endif" id="manageSubscriptions" style="">
                                    <ul class="nav nav-collapse subnav">
                            ...
                            <li class="submenu">
                                <a data-toggle="collapse" href="#packageOrders" aria-expanded="{{(request()->path() == 'admin/all/orders' || request()->path() == 'admin/pending/orders' || request()->path() == 'admin/processing/orders' || request()->path() == 'admin/completed/orders' || request()->path() == 'admin/rejected/orders') ? 'true' : 'false' }}">
                                <span class="sub-item">Manage Orders</span>
                                <span class="caret"></span>
                                </a>
                                <div class="collapse {{(request()->path() == 'admin/all/orders' || request()->path() == 'admin/pending/orders' || request()->path() == 'admin/processing/orders' || request()->path() == 'admin/completed/orders') ? 'show' : '' }}" id="packageOrders" style="">
                                    <ul class="nav nav-collapse subnav">
                ...
                <li class="nav-item
                    ...
                    <div class="collapse
                        ...
                        <ul class="nav nav-collapse">
                            ...
                            <li class="submenu">
                                <a data-toggle="collapse" href="#productManagement" aria-expanded="{{(request()->path() == 'admin/category' || request()->is('admin/category/*/edit') || request()->routeIs('admin.product.type') || request()->routeIs('admin.product.create') || request()->routeIs('admin.product.index') || request()->routeIs('admin.product.edit')) ? 'true' : 'false' }}">
