                        ...
                        <tr>
                          ...
                          <td>
                              @if (strpos($user->photo, 'facebook') !== false || strpos($user->photo, 'google'))
                                <img class="rounded-circle" src="{{$user->photo ? $user->photo : asset('assets/front/img/user/profile.jpg')}}" alt="" width="60">
                            @else
                                <img src="{{!empty($user->photo) ? asset('assets/front/img/user/'.$user->photo) : ''}}" alt="" width="60">
                            @endif
                          </td>
