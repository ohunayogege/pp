...
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <form
        class=""
        action="{{route('admin.heading.update', $lang_id)}}"
        method="post"
      >
        @csrf
              ...
              <div class="col-lg-8 offset-lg-2">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="service_title" value="{{empty(old('service_title')) ? $abs->service_title : old('service_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="service_subtitle" value="{{empty(old('service_subtitle')) ? $abs->service_subtitle : old('service_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="service_details_title" value="{{empty(old('service_details_title')) ? $abs->service_details_title : old('service_details_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="portfolio_title" value="{{empty(old('portfolio_title')) ? $abs->portfolio_title : old('portfolio_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="portfolio_subtitle" value="{{empty(old('portfolio_subtitle')) ? $abs->portfolio_subtitle : old('portfolio_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="portfolio_details_title" value="{{empty(old('portfolio_details_title')) ? $abs->portfolio_details_title : old('portfolio_details_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="faq_title" value="{{empty(old('faq_title')) ? $abs->faq_title : old('faq_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="faq_subtitle" value="{{empty(old('faq_subtitle')) ? $abs->faq_subtitle : old('faq_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="pricing_title" value="{{empty(old('pricing_title')) ? $abe->pricing_title : old('pricing_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="pricing_subtitle" value="{{empty(old('pricing_subtitle')) ? $abe->pricing_subtitle : old('pricing_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="product_title" value="{{empty(old('product_title')) ? $abe->product_title : old('product_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="product_subtitle" value="{{empty(old('product_subtitle')) ? $abe->product_subtitle : old('product_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="product_details_title" value="{{empty(old('product_details_title')) ? $abe->product_details_title : old('product_details_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="cart_title" value="{{empty(old('cart_title')) ? $abe->cart_title : old('cart_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="cart_subtitle" value="{{empty(old('cart_subtitle')) ? $abe->cart_subtitle : old('cart_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="checkout_title" value="{{empty(old('checkout_title')) ? $abe->checkout_title : old('checkout_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="checkout_subtitle" value="{{empty(old('checkout_subtitle')) ? $abe->checkout_subtitle : old('checkout_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input
                          class="form-control"
                          name="knowledgebase_details_title"
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="blog_title" value="{{empty(old('blog_title')) ? $abs->blog_title : old('blog_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="blog_subtitle" value="{{empty(old('blog_subtitle')) ? $abs->blog_subtitle : old('blog_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="blog_details_title" value="{{empty(old('blog_details_title')) ? $abs->blog_details_title : old('blog_details_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="rss_title" value="{{empty(old('rss_title')) ? $abe->rss_title : old('rss_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="rss_subtitle" value="{{empty(old('rss_subtitle')) ? $abe->rss_subtitle : old('rss_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="rss_details_title" value="{{empty(old('rss_details_title')) ? $abe->rss_details_title : old('rss_details_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="gallery_title" value="{{empty(old('gallery_title')) ? $abs->gallery_title : old('gallery_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="gallery_subtitle" value="{{empty(old('gallery_subtitle')) ? $abs->gallery_subtitle : old('gallery_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="career_title" value="{{empty(old('career_title')) ? $abe->career_title : old('career_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="career_subtitle" value="{{empty(old('career_subtitle')) ? $abe->career_subtitle : old('career_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="course_title" value="{{empty(old('course_title')) ? $abex->course_title : old('course_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="course_subtitle" value="{{empty(old('course_subtitle')) ? $abex->course_subtitle : old('course_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="course_details_title" value="{{empty(old('course_details_title')) ? $abex->course_details_title : old('course_details_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="event_calendar_title" value="{{empty(old('event_calendar_title')) ? $abe->event_calendar_title : old('event_calendar_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="event_calendar_subtitle" value="{{empty(old('event_calendar_subtitle')) ? $abe->event_calendar_subtitle : old('event_calendar_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="team_title" value="{{empty(old('team_title')) ? $abs->team_title : old('team_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="team_subtitle" value="{{empty(old('team_subtitle')) ? $abs->team_subtitle : old('team_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="contact_title" value="{{empty(old('contact_title')) ? $abs->contact_title : old('contact_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="contact_subtitle" value="{{empty(old('contact_subtitle')) ? $abs->contact_subtitle : old('contact_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="quote_title" value="{{empty(old('quote_title')) ? $abs->quote_title : old('quote_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="quote_subtitle" value="{{empty(old('quote_subtitle')) ? $abs->quote_subtitle : old('quote_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="error_title" value="{{empty(old('error_title')) ? $abs->error_title : old('error_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="error_subtitle" value="{{empty(old('error_subtitle')) ? $abs->error_subtitle : old('error_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <input class="form-control" name="event_title" value="{{empty(old('event_title')) ? $abs->event_title : old('event_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <input class="form-control" name="event_subtitle" value="{{empty(old('event_subtitle')) ? $abs->event_subtitle : old('event_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <input class="form-control" name="event_details_title" value="{{empty(old('event_details_title')) ? $abs->event_details_title : old('event_details_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <input class="form-control" name="cause_title" value="{{empty(old('cause_title')) ? $abs->cause_title : old('cause_title')}}">
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <input class="form-control" name="cause_subtitle" value="{{empty(old('cause_subtitle')) ? $abs->cause_subtitle : old('cause_subtitle')}}">
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <input class="form-control" name="cause_details_title" value="{{empty(old('cause_details_title')) ? $abs->cause_details_title : old('cause_details_title')}}">
