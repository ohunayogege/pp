...
class PaystackGatewayController extends Controller
{
  ...
  public function __construct()
  {
    ...
    // $this->api_key = $payData['key'];

    // later it will be dynamic
    $this->api_key = 'sk_test_45b0b207ffa006eeb5fc74ea35d01e673be15ade';
  }
  ...
  public function redirectToPaystack(Request $request)
  {
    ...
    if (!Auth::user()) {
        Session::put('link', route('course_details', ['slug' => $course->slug,'id' => $request->course_id]));
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_HTTPHEADER     => [
        'authorization: Bearer sk_test_45b0b207ffa006eeb5fc74ea35d01e673be15ade',
  ...
  public function notify(Request $request)
  {
    ...
    if ($urlInfo['trxref'] === $urlInfo['reference']) {
      ...
      MailController::sendMail($fileName);
