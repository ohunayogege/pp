    ...
    public function sendMails($po, $be, $bex)
    {
        ...
        if ($bex->recurring_billing == 1) {
            ...
            if ($po->gateway_type == 'online') {
                ...
                $subject = "Subscribed to " . $package->title;
                $body = "You have subscribed successfully to " . $package->title . "<br><strong>Activation Date:</strong> " . $activationDate->toFormattedDateString() . "<br><strong>Expire Date:</strong> " . $expireDate->toFormattedDateString();
            }
            // if offline gateway
            else {
                ...
                $subject = "Subscription Request for " . $package->title;
                $body = "Your subscription request for " . $package->title . "<br>Activation Date & Expire Date will be notified via mail once Admin accept the request";
            }
            ...
            $subject = "Order placed for " . $po->package_title;
            $body    = 'Hello <strong>' . $po->name . '</strong>,<br/>Your order has been placed successfully. We have attached an invoice in this mail.<br/>Thank you.';
