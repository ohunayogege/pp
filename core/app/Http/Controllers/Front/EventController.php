...
class EventController extends Controller
{
    public function makePayment(Request $request)
    {
        ...
        if ($request->payment_method == "Stripe") {
            ...
            return redirect()->route('front.event_details', [$request->event_slug, $request->event_id]);
        }
    }
    ...
    public function sendMailPHPMailer($request, $file_name, $be)
    {
        ...
        if ($be->is_smtp == 1) {
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = "You made your event purchase successful";
                $mail->Body = "This is a confirmation mail from us. Please see the attachment for details. Thank you";
                $mail->send();
