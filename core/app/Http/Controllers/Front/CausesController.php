...
class CausesController extends Controller
{
    public function makePayment(Request $request)
    {
        ...
        if ($request->payment_method == "Stripe") {
            ...
            return redirect()->route('front.cause_details', [$request->donation_slug, $request->donation_id]);
        }
    }
    ...
    public function store($request, $transaction_id, $transaction_details, $amount, $bex)
    {
        return $donation = DonationDetail::create([
            ...
            'name' => $request["name"] ? $request["name"] : "anonymous",
            'email' => $request["email"] ? $request["email"] : "anoymous",
            'phone' => $request["phone"] ? $request["phone"] : "anoymous",
            'amount' => $amount,
