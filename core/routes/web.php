...
Route::get('assets/front/digital_products/{file}', function () {
    return back();
});
...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::group(['prefix' => 'causes'], function () {
        Route::get('/', 'Front\FrontendController@causes')->name('front.causes');
        Route::get('/{slug}/cause/{id}', 'Front\FrontendController@causeDetails')->name('front.cause_details');
    });

    //Events Page
    Route::group(['prefix' => 'events'], function () {
        Route::get('/', 'Front\FrontendController@events')->name('front.events');
        Route::get('/{slug}/event/{id}', 'Front\FrontendController@eventDetails')->name('front.event_details');
    });
    ...
    Route::get('/knowledgebase', 'Front\FrontendController@knowledgebase')->name('front.knowledgebase');
    Route::get('/knowledgebase/{slug}/{id}', 'Front\FrontendController@knowledgebase_details')->name('front.knowledgebase_details');
...
Route::group(['middleware' => ['web', 'setlang']], function () {
    ...
    Route::get('/courses', 'Front\CourseController@courses')->name('courses');
    Route::post('/course/review', 'Front\CourseController@giveReview')->name('course.review');
    Route::get('/course/{slug}/{id}', 'Front\CourseController@courseDetails')->name('course_details');
});
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Basic Settings'], function () {
        ...
        Route::get('/homeTheme', 'Admin\BasicController@homeTheme')->name('admin.homeTheme');
        Route::post('/homeTheme/post', 'Admin\BasicController@updateHomeTheme')->name('admin.homeTheme.update');
    ...
    Route::group(['middleware' => 'checkpermission:Events Management'], function () {
        ...
        Route::post('/event/slider', 'Admin\EventController@slider')->name('admin.event.slider');
    ...
    Route::group(['middleware' => 'checkpermission:Donation Management'], function () {
        ...
        Route::post('/donation/upload', 'Admin\DonationController@upload')->name('admin.donation.upload');
    ...
    Route::group(['middleware' => 'checkpermission:Course Management'], function () {
        ...
        Route::post('/course/image_upload', 'Admin\CourseController@uploadCourseImage')->name('admin.course_image.upload');
        Route::post('/course/instructor_image_upload', 'Admin\CourseController@uploadInstructorImage')->name('admin.instructor_image.upload');
        ...
        Route::post('/course/{id}/image_update', 'Admin\CourseController@updateCourseImage')->name('admin.course_image.update');
        Route::post('/course/{id}/instructor_image_update', 'Admin\CourseController@updateInstructorImage')->name('admin.instructor_image.update');
